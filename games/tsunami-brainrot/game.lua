...
-- Tsunami wave configuration
local WAVE_TYPES = {
    {name = "Slow",      speed = 20, warning = 10, weight = 40},
    {name = "Medium",    speed = 35, warning = 7,  weight = 30},
    {name = "Fast",      speed = 50, warning = 5,  weight = 20},
    {name = "Lightning", speed = 80, warning = 3,  weight = 10},
}
local WAVE_INTERVAL_MIN = 30      -- Minimum seconds between waves
local WAVE_INTERVAL_MAX = 45      -- Maximum seconds between waves
local WAVE_SPAWN_X = -410         -- Wave spawns just off the left edge
local WAVE_HEIGHT = 60            -- Height of the wave wall
local WAVE_COLOR = Color3.fromRGB(0, 100, 200)  -- Blue wave color

-- Shelters (safe spots during waves)
local SHELTERS = {
    {x = 200, z = 0, width = 12, depth = 12},      -- Common zone shelter
    {x = 100, z = 20, width = 10, depth = 10},     -- Uncommon/Rare border
    {x = 0, z = -15, width = 10, depth = 10},      -- Rare/Epic border
    {x = -100, z = 10, width = 8, depth = 8},      -- Epic zone shelter
    {x = -225, z = -10, width = 8, depth = 8},     -- Legendary zone shelter
    {x = -350, z = 0, width = 6, depth = 6},       -- Secret zone shelter (small!)
}
...
-- Tsunami wave state
local waveState = {
    active = false,           -- Is a wave currently active?
    warning = false,          -- Is the wave in warning phase?
    part = nil,               -- The visual wave Part
    xPosition = WAVE_SPAWN_X, -- Current X position of wave
    speed = 0,                -- Current wave speed (studs/second)
    waveType = nil,           -- Current wave type info
    warningTimeLeft = 0,      -- Seconds remaining in warning phase
    nextWaveTimer = 0,        -- Seconds until next wave spawns
}
local shelterParts = {}       -- References to shelter parts for visual
...
local function createMap()
    ...
    -- Create shelters for wave protection
    createShelters()
end
